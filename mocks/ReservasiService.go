...
// NotificationTransactionStatus provides a mock function with given fields: kodeTransaksi
func (_m *ReservasiService) NotificationTransactionStatus(kodeTransaksi string) error {
